...
#ifndef __SLAB_SUPPORT_H_
#define __SLAB_SUPPORT_H_

#include "slab.h"

/* This slab type is meant to imitate the wire cables you often see on bridges. Objects do not collide with this type of slab. */
